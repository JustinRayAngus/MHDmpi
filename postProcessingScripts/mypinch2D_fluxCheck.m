...
xlabel('z direction'); shading flat;
ylabel('r direction');
title(['Ez at t = ',num2str(tout(tindex),3),' t_A']);
axis('square'); axis([Zce(2) Zce(end-1) Xce(3) Xce(end-2)]);
%
%
%
...
xlabel('z direction'); shading flat;
ylabel('r direction');
title(['Ez0 at t = ',num2str(tout(tindex),3),' t_A']);
axis('square'); axis([Zce(2) Zce(end-1) Xce(3) Xce(end-2)]);
%
%
subplot(3,2,5);
pcolor(Zcc,Xcc,Jz(:,:,tindex)'); colorbar; box on
xlabel('z direction'); shading flat;
ylabel('r direction');
title(['Jz at t = ',num2str(tout(tindex),3),' t_A']);
axis('square'); axis([Zce(2) Zce(end-1) Xce(3) Xce(end-2)]);
%
%
