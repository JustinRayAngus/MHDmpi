...
void computeFluxes(const domainGrid& Xgrid, const int order)
{
   ...
   matrix2D<double> Cspeed0i, Cspeed, Cspeed0e, Cvac; 
 
   Cspeed0i.initialize(nXcc,nZcc,0.0);
   Cspeed.initialize(nXcc,nZcc,0.0);
   Cspeed0e.initialize(nXcc,nZcc,0.0);
