...
vector<double> N, M, B, Ez, E;   // time-evolving variables
vector<double> eta, Cs, V, P, T, S, J, J0, Qvisc; // derived variables
vector<double> etace, Jcc, Ezcc, VBce;
vector<double> Nold, Mold, Eold, Bold, Ezold, Ezhalf;
